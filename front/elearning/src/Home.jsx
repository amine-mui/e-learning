    ...
    <h1>What others said about us</h1>
      <div class="pers">
        ...
        <div class="pe">
          ...
          <div class="p-name">Dhia : i always thought that i was a master of react, until i found the course provided by mr.ahmed! just wow...</div>
        ...
        <div class="pe">
          <img src={img1} alt=""/>
          <div class="p-name">Hadil : finally i can live mybest life and teach from everywhere</div>
        ...
        <div class="pe">
          <img src={img2} alt=""/>
          <div class="p-name">Ali : thanks guys for this incredible platform</div>
